...
// uma semana. Nestes acampamentos os alunos são divididos em cabanas coletivos por gênero e idade,
// sempre com um adulto que, além de dormir com o grupo no cabana, também são responsáveis por criar e
// executar várias atividades, como por exemplo jogos, excursões, Gincanas Noturnas, etc.
...
// deve ser retirado do grupo, e a contagem inicia novamente segundo a ficha do aluno que acabou de ser eliminado.
// Para ficar mais interessante, quando o valor que consta na ficha é par, a contagem é feita no sentido horário
// e quando o valor que consta na ficha é ímpar, a contagem é feita no sentido anti-horário.
...
// Entrada: A entrada contém vários casos de teste. A primeira linha de cada caso de teste contém um inteiro
// N (1 ≤ N ≤ 100), indicando a quantidade de alunos que farão parte de cada círculo. Em seguida,
// as N linhas de cada caso de teste conterão duas informações, o Nome e o Valor (1 ≤ Valor ≤ 500)
// que consta na ficha de cada aluno, separados por um espaço, na ordem de entrada na formação do círculo inicial.
...
// Saida: Para cada caso de teste, deve-se apresentar a mensagem Vencedor(a): xxxxxx, com um espaço após o sinal
// ":" indicando qual é o aluno do grupo que venceu a brincadeira.

public class Gincana_acampamento {
    ...
    public static void main(String[] args) {
        ...
        // informando o numero de alunos

        numeroDeAlunos = Integer.parseInt(scr.next());

        // while de acordo com o numero de alunos
        ...
        while (numeroDeAlunos > 0) {
            ...
            // todos os testes exuctados para  mostra o vencedor
